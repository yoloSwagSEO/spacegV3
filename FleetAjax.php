...
$fleet['fleetlist']	= '';
$fleet['amount'] 	= 0;
//on Fait la liste des besoin par rapport a l'envoi et on vérifie si l'on as les besoin
...
//On as pas toutes la flottes demander on renvoi une erreur
...
//on check si la galaxy n'est pas négative
...
//on check si le systeme n'est pas négatif
...
if (!(($_POST["mission"] == 6) OR ($_POST["mission"] == 8) OR ($_POST["mission"] == 16)))
{
...
//echo $TargetRow['id_owner'].' | '.$_POST['mission'];

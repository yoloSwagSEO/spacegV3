...
$helptxt['enableStickyTopics'] = 'Les sujets épinglés sont des sujets qui restent en haut de la liste des sujets. Ils sont surtout utilisés pour mettre en valeur des sujets
	importants. Bien que vous puissiez changer cette préférence dans les permissions, par défaut, seuls les modérateurs et les administrateurs peuvent épingler des sujets.';
...
$helptxt['karmaMode'] = 'Le Karma est une fonction qui affiche la popularité d\'un membre.  Les membres, s\'ils y sont autorisés, peuvent
                \'Applaudir\' ou \'Huer\' les autres membres; c\'est la façon de calculer la popularité d\'un membre. Vous pouvez changer le
                nombre de messages nécessaires pour avoir un &quot;karma&quot;, le temps nécessaire entre un second vote pour la même personne, et si les administrateurs
                ont à attendre ce laps de temps aussi.<br /><br />Définir si des groupes de membres peuvent ou non fouetter et applaudir d\'autres membres est effectué
                par une permission.  Si vous avez des problèmes à faire fonctionner cette propriété pour tout le monde, vérifiez deux fois vos permissions.';
...
$helptxt['hotTopicPosts'] = 'Indiquez le nombre de messages nécessaires afin que le sujet reçoive les étiquettes &quot;sujet populaire&quot; et &quot;sujet très populaire&quot;.';
...
$helptxt['fixLongWords'] = 'Cette option coupe les mots plus longs qu\'un certain nombre de lettres en plusieurs parties, pour ne pas (trop) déformer la charte graphique de votre forum. Évitez les valeurs inférieures à 40. Ne fonctionne pas sur les forums utilisant l\'UTF-8 et PHP < 4.4.0. En l\'occurrence, cela ' . (empty($GLOBALS['context']['utf8']) || version_compare(PHP_VERSION, '4.4.0') != -1 ? 'fonctionnera' : 'ne fonctionnera pas') . ' sur votre serveur.';

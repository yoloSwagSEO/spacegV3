...
$txt['themeadmin_explain'] = 'Les thèmes <em>(parfois appelés \'skins\' ou \'habillages\')</em> définissent l\'apparence visuelle de votre forum. Ces paramètres affectent la sélection des thèmes et quels thèmes les invités et les autres membres utilisent.';
...
$txt['theme_install_file'] = 'Depuis une archive de votre ordinateur';
...
$txt['themeadmin_list_tip'] = 'Rappelez-vous, les paramètres de disposition peuvent différer d\'un thème à l\'autre.  Cliquez sur le nom du thème ci-dessous pour paramétrer ses options, changer son répertoire ou ses URLs, ou trouvez d\'autres options.';

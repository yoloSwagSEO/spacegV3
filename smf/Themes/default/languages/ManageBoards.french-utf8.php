...
$txt['boards_and_cats_desc'] = 'Modifiez vos catégories et sections ici. Listez les modérateurs comme ceci <em>&quot;identifiant&quot;, &quot;identifiant&quot;</em>. (Utilisez les identifiants des membres, pas leurs noms affichés !)<br />Pour créer une nouvelle section, cliquez sur le bouton Ajouter une section. Pour faire une sous-section, choisissez "Sous-section de..." dans la liste déroulante nommée Ordre lors de la création d\'une section.';

...
$txt['permissionhelp_karma_edit'] = 'Le Karma est une fonctionnalité qui affiche la popularité d\'un membre. Pour l\'utiliser, vous devez l\'avoir activée dans \'Configuration des caractéristiques et options\'. Cette permission autorise un groupe de membres à ajouter un vote. Cette permission n\'a pas d\'effet sur les invités.';
...
$txt['permissionhelp_send_topic'] = 'Cette permission autorise un utilisateur à envoyer par e-mail un sujet à des amis, en entrant leur adresse e-mail et en autorisant l\'ajout d\'un message.';

...
$txt['language_extracted'] = 'Le paquet de langue a été extrait, vous pouvez maintenant l\'utiliser (en le choisissant dans vos paramètres).';
...
$txt['packages_latest'] = 'Derniers Paquets';
$txt['packages_latest_fetch'] = 'Tentative de récupération des paquets les plus récents et populaires depuis www.simplemachines.org...';
...
$txt['package_will_fail_warning'] = 'Au moins une erreur a été rencontrée lors d\'un test d\'installation de ce paquet.
...
$txt['package_uninstall_cannot'] = 'Ce paquet ne peut pas être désinstallé parce qu\'il n\'a pas de désinstallateur&nbsp;!<br /><br />Veuillez contacter l\'auteur du mod pour plus d\'informations.';
...
$txt['package_ftp_why_download'] = 'Pour transférer des paquets, le répertoire <tt>/Packages</tt> et les fichiers qu\'il contient doivent être inscriptibles (et ils ne le sont pas actuellement).  Le gestionnaire de paquets peut utiliser vos informations FTP pour rectifier cela.';

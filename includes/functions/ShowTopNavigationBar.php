	...
	function ShowTopNavigationBar ($CurrentUser, $CurrentPlanet)
	{
		...
		if (($CurrentPlanet["deuterium"] >= $CurrentPlanet["deuterium_max"])) {
			...
			$parse['deuterium'] = $deuterium;
                ...
                $parse['credit'] = Format::pretty_number($CurrentPlanet["credit"]);
                
		$parse['top_metal_rate'] = $CurrentPlanet["metal_perhour"];
		$parse['top_crystal_rate'] = $CurrentPlanet["crystal_perhour"];
		$parse['top_deut_rate'] = $CurrentPlanet["deuterium_perhour"];
		$parse['top_cred_rate'] = $CurrentPlanet["credit_perhour"];
                
		$parse['total_metal'] = $CurrentPlanet["metal"];
		$parse['total_crystal'] = $CurrentPlanet["crystal"];
		$parse['total_deut'] = $CurrentPlanet["deuterium"];
